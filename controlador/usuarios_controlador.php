    ...
    public function editarContra(){
		...
		if($r > 0){
            if($con_nueva == $con_confirmar){
                ...
                echo json_encode(array("mensaje"=>" Error, la contraseña nueva no coincide", "icono"=>"error"));
            }
            
        } else{
            echo json_encode(array("mensaje"=>" No coincide", "icono"=>"error"));
        }
    }

    public function reporteUsuarios(){
        $datos= usuarios_modelo::mdlListado();
        require_once "vista/admin/usuarios/reporteUsuarios.php";
    }
