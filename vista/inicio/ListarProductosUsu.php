<div style="background-color: whitesmoke;">
  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5 contenedor">
      ...
      <img style="width: 33% ; height: 10%;" src="public/logoani/PB.PNG" alt="">
  ...
  <div class="row">
    ...
    ?>
      <div class="col-lg-4">
        <div class="card shadow-sm" style="margin-left: 1rem; margin-top: 1rem; border-radius: 10px;">
          <br>
          <div class="card" style="width: 26rem;">
            ...
            <div class="card-body">
              ...
              <h4>
                <p class="card-title"><?php echo  $valor["Pro_Nombre"]; ?></p>
              </h4>
              ...
              <form action="" method="post" class="frmCarro">
                ...
                <input type="submit" name="aceptar" value="Añadir al carrito" class="btn btn-danger" style="border-radius: 8px;">
