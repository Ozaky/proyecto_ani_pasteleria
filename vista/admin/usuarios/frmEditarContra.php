                ...
                <table class="table align-items-center mb-0">
                    <form action="?controlador=usuarios&accion=editarContra" method="post" id="frmEditar">
                        <div class="input-group input-group-outline my-3">
                            ...
                            <input type="password" name="con_actual" class="form-control">
                        </div>
                        <div class="input-group input-group-outline my-3">
                            <label class="form-label">Nueva Contraseña</label>
                            <input type="password" name="con_nueva" class="form-control">
                        </div>
                        <div class="input-group input-group-outline my-3">
                            <label class="form-label">Confirmar Contraseña</label>
                            <input type="password" name="con_confirmar" class="form-control">
                        </div>
