...
<head>
  ...
  <link rel="icon" href="public/logoani/ani.ico">
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark justify-content-end" style="padding-top: 1rem; padding-bottom: 0.6rem; box-shadow: 2px 3px 5px #d4d4d4;">
        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="?controlador=inicio&accion=index" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
              ...
              <h2 style="font-style: oblique; margin-left: 60px;">Ani Pasteleria</h2>
  ...
  ================================================== -->
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img src="public/logoani/pA.jpg" width="450" height="400" alt="" style="box-shadow: rgba(0, 0, 0, 0.35)  0px 2.8px 7px 3px;">
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2">
            <h2 class="featurette-heading">“Somos seres extraordinarios viviendo en un mundo donde existen los postres, por eso sé feliz“</h2>
          </div>
          <div class="col-md-5 order-md-1">
            <img src="public/logoani/pC.jpg" width="450" height="400" alt="" style="box-shadow: rgba(0, 0, 0, 0.35)  0px 2.8px 7px 3px;">
          </div>
        </div>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">Amar 100% lo que hacemos</h2>
            <p class="lead">Creer en la magia para crear absolutamente todo con una energía que mueva tu interior, sacarte muchas sonrisas y despertar lo mejor que hay en ti.  Seleccionar los mejores ingredientes para que nuestras recetas sean identificadas por su sabor y estética, seguir aprendiendo cada día y retarnos a ser siempre mejores acompañados por la alegría, la honestidad y la pasión.</p>
          </div>
          <div class="col-md-5">
            <img src="public/logoani/PB.PNG" width="450" height="400" alt="" style="box-shadow: rgba(0, 0, 0, 0.35)  0px 2.8px 7px 3px;">
          </div>
        </div>
